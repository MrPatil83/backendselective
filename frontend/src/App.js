    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/about" element={<About />} />
          <Route path="/contact" element={<Contact />} />
          <Route path="/products/aluminium-windows" element={<AluminiumWindows />} />
          <Route path="/products/door-seals" element={<DoorSeals />} />
          <Route path="/products/railings" element={<Railings />} />
          <Route path="/products/queue-manager" element={<QueueManager />} />
          <Route path="/products/invisible-grill" element={<InvisibleGrill />} />
          <Route path="/products/office-partitions" element={<OfficePartitions />} />
          <Route path="/products/bathroom-partitions" element={<BathroomPartitions />} />
        </Routes>
        <Footer />
      </div>
    </Router>
